...
void BaseApplication::createCamera(void)
{
	...
	mCameraNode = mSceneMgr->getRootSceneNode()->createChildSceneNode("camera node");
...
void BaseApplication::createFrameListener(void)
{
	...
	//mTrayMgr = new OgreBites::SdkTrayManager("InterfaceName", mWindow, mMouse, this); // an other OGRE version provides this constructor
