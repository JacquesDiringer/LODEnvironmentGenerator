...
namespace Generator
{
	...
	{
		shared_ptr<SimpleObjectDisplayable> displayable = nullptr;

		if (!_isPlaceHolder)
		{
			displayable = make_shared<SimpleObjectDisplayable>(_modelSimpleDisplayable);
		}
